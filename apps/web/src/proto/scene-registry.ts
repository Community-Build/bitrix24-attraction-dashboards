...
export const sceneMetadata: ProtoSceneMetadata[] = [
  ...
  },
  {
    id: 'deal-analysis',
    label: 'Анализ сделок',
    description: 'Текущие сделки, объяснимое здоровье, риски и следующее действие для вмешательства.',
    focus: 'Сделки / риски / действия',
    kpis: [],
  },
  {
    id: 'sales',
  ...
  },
  {
    id: 'source-cohorts',
    label: 'Конверсии',
    description: 'Когорта создания сделки по источникам, менеджерам и заказчикам с траекторией стадий и фактических действий.',
    focus: 'Источники / менеджеры / факты',
    kpis: [],
  },
  {
    id: 'revenue-velocity',
