    ...
    <>
      ...
      >
        ...
        <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm leading-6 text-amber-950">
          ...
          служебным признакам источника. Если источник не называет физического
          автора, исходящее остаётся у ответственного менеджера и показывается
          отдельно от подтверждённого авторства.
        </div>
